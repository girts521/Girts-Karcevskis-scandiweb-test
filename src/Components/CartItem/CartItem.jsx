...
{({ loading, data }) => {
        ...
        <div className={styles.productDescription}>
          ...
          <div className={styles.price}>{data.product.prices[0].currency.symbol + data.product.prices[0].amount}</div>
        ...
        <div className={styles.productImg}>
          <div className={styles.btns}>
            ...
            <div className={styles.quantity}>{this.props.product.quantity}</div>
...
<path d="M11.25 4.06857L5.625 9.6876L11.25 15.3066" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <div onClick={() => {this.nextPhoto(data.product.gallery.length)}} className={styles.arrowRight}>
            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M11.25 4.06857L5.625 9.6876L11.25 15.3066" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
            </div>
          ...
          <img src={data.product.gallery[this.state.photoIndex]} alt="" />
        </div>
        </>)}}}
        </Query>
      </div>
